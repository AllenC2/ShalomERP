...
@section('content')
    ...
    <div class="bg-light min-vh-100">
        <div class="container py-4">
            ...
            <!-- Header moderno -->
            @auth
                <a href="{{ route('empleados.show', Auth::user()->id) }}" class="header-text ms-3 text-decoration-none"
                    style="color: inherit; text-align: left;">
                    <div class="page-header m-0">
                        <div class="header-content d-grid"
                            style="grid-template-columns: 1fr auto; align-items: center; gap: 1.5rem; width: 100%;">
                            <div class="d-flex align-items-center">
                                <div class="header-icon d-flex align-items-center justify-content-center"
                                    style="background: linear-gradient(90deg, #E1B240 0%, #79481D 100%); color:#fff; border-radius: 50%; aspect-ratio: 1 / 1; width: 68px; font-size: 1.5rem; font-weight: 700; text-transform: uppercase;">
                                    {{ collect(explode(' ', Auth::user()->name ?? 'U'))->map(fn($w) => mb_substr($w, 0, 1))->take(2)->join('') }}
                                </div>
                                <div class="mr-4 ms-3 text-truncate" style="min-width: 0;">
                                    <h1 class="page-title mb-0" style="text-align: left;">{{ Auth::user()->name ?? 'Usuario' }}
                                    </h1>
            ...
            @else
                <div class="alert alert-info mb-4">
                    ...
                    <strong>Modo de prueba:</strong> No hay usuario autenticado. En producción, esta página requiere
                    autenticación.
                </div>
            @endauth
            ...
            <div class="config-buttons-section mb-5">
                <div class="row g-3">
                    <div class="col-md-6">
                        <button type="button" class="config-btn-card text-decoration-none" data-bs-toggle="modal"
                            ...
                            <div class="config-card-icon"
                                style="background: linear-gradient(90deg, #E1B240 0%, #79481D 100%);">
                    ...
                    <div class="col-md-6">
                        <button type="button" class="config-btn-card text-decoration-none" data-bs-toggle="modal"
                            data-bs-target="#toleranciaModal">
                            <div class="config-card-icon"
                                style="background: linear-gradient(90deg, #ff6b35 0%, #f7931e 100%);">
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                        <div class="modal-body" style="padding: 2rem;">
                            ...
                            <div class="enterprise-info-section mb-5 w-100"
                                    ...
                                    <div class="card-header" style="background: #fff;">
                                        <div class="header-content">
                                            ...
                                            <div class="header-text">
                                                ...
                                                <p class="card-subtitle text-muted mb-0">Esta información se imprimirá en
                                                    todos los recibos y facturas</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control modern-input" id="rfc"
                                                                name="rfc"
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control modern-input" id="email"
                                                                name="email"
                                                ...
                                                <div class="col-md-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control modern-input"
                                                                id="calle_numero" name="calle_numero"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control modern-input" id="ciudad"
                                                                name="ciudad"
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-7">
                                                                ...
                                                                <select class="form-select modern-input" id="estado"
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <input type="text" class="form-control modern-input"
                                                                    id="pais" name="pais"
                                                                    value="{{ old('pais', isset($infoEmpresa) ? ($infoEmpresa['pais'] ?: 'México') : 'México') }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                        <div class="modal-body" style="padding: 2rem;">
                            ...
                            <div class="whatsapp-reminder-section mb-5 w-100"
                                style="margin-right: 0; margin-left: 0; max-width: 100%;">
                                <div class="card modern-card">
                                    <div class="card-header" style="background: #fff;">
                                        <div class="header-content">
                                            ...
                                            <div class="header-text">
                                                ...
                                                <p class="card-subtitle text-muted mb-0">Personaliza el mensaje que se envía
                                                    a los clientes para recordar sus pagos</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form id="whatsapp-form" action="{{ route('ajustes.recordatorioWhatsApp') }}"
                                            method="POST">
                                            @csrf
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li><code>{nombreCliente}</code> - Nombre del cliente
                                                                    </li>
                                                                    <li><code>{nombrePaquete}</code> - Nombre del paquete
                                                                        contratado</li>
                                                                </ul>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li><code>{cantidadPagoProximo}</code> - Monto del
                                                                        próximo pago</li>
                                                                    <li><code>{fechaPago}</code> - Fecha del próximo pago
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="card bg-light h-100 ">
                                                        <div class="card-body d-flex align-items-center ">
                                                            <div class="whatsapp-preview p-3 rounded w-100"
                                                                style="background: #DCF8C6; border-left: 4px solid #25D366;">
                                                                <div class="d-flex align-items-start">
                                                                    <i class="bi bi-whatsapp text-success me-2 mt-1"></i>
                                                                    <div>
                                                                        <small class="text-muted d-block mb-1">Vista previa
                                                                            con datos de ejemplo:</small>
                                                                        <p id="previewMensaje" class="mb-0"
                                                                            style="font-size: 0.95rem; line-height: 1.4;">
                                                                            Hola Juan Pérez, te recordamos que el pago de tu
                                                                            paquete Premium por $2,500.00 será cobrado el
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                        <div class="modal-body" style="padding: 2rem;">
                            ...
                            <div class="registro-publico-section mb-5 w-100"
                                style="margin-right: 0; margin-left: 0; max-width: 100%;">
                                <div class="card modern-card">
                                    <div class="card-header" style="background: #fff;">
                                        <div class="header-content">
                                            ...
                                            <div class="header-text">
                                                ...
                                                <p class="card-subtitle text-muted mb-0">Controla si cualquier persona puede
                                                    registrarse o solo los administradores</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form id="registro-publico-form" action="{{ route('ajustes.registroPublico') }}"
                                            method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">
                                                            <i class="bi bi-shield-lock me-2"></i>Estado del Registro
                                                            Público
                                                        </label>
                                                        <div class="form-check form-switch" style="font-size: 1.2rem;">
                                                            <input class="form-check-input" type="checkbox" role="switch"
                                                                id="registro_publico" name="registro_publico" value="1" {{ old('registro_publico', $registroPublico) ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="registro_publico"
                                                                id="switch-label">
                                                                <strong
                                                                    id="switch-text">{{ $registroPublico ? 'Activado' : 'Desactivado' }}</strong>
                                                            </label>
                                                        </div>
                                                        <div class="form-text">
                                                    ...
                                                    <div class="alert alert-info mb-3">
                                                        ...
                                                        <ul class="mb-0 small">
                                                            <li><strong>Activado:</strong> La página de registro estará
                                                                disponible públicamente</li>
                                                            <li><strong>Desactivado:</strong> Solo los administradores
                                                                podrán crear nuevos usuarios desde el panel de empleados
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="card bg-light h-100">
                                                        <div class="card-body">
                                                            <div class="registro-preview p-3 rounded w-100"
                                                                id="registro-preview">
                                                                <div class="d-flex align-items-start">
                                                                    <i class="bi bi-person-check text-primary me-2 mt-1"
                                                                        id="preview-icon"></i>
                                                                    <div>
                                                                        <small class="text-muted d-block mb-1">Acceso al
                                                                            registro:</small>
                                                                        <p id="previewRegistro" class="mb-2"
                                                                            style="font-size: 0.95rem; line-height: 1.4;">
                                                                            @if($registroPublico)
                                                                                El registro está <strong
                                                                                    class="text-success">disponible
                                                                                    públicamente</strong>. Cualquier persona
                                                                                puede crear una cuenta nueva.
                                                                            @else
                                                                                El registro está <strong
                                                                                    class="text-warning">restringido</strong>.
                                                                                Solo los administradores pueden crear nuevos
                                                                                usuarios.
                                                                            @endif
                                                                        </p>
                                                                        <div class="small text-muted">
                                                                            ...
                                                                            <span id="urlRegistro">
                                                                                @if($registroPublico)
                                                                                    <span
                                                                                        class="text-success">{{ url('/register') }}
                                                                                        (Activa)</span>
                                                                                @else
                                                                                    <span
                                                                                        class="text-muted">{{ url('/register') }}
                                                                                        (Bloqueada)</span>
                                                                                @endif
                                                                            </span>
                                                                        </div>
            ...
            <div class="modal fade" id="toleranciaModal" tabindex="-1" aria-labelledby="toleranciaModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                        <div class="modal-body" style="padding: 2rem;">
                            ...
                            <div class="tolerancia-pagos-section mb-5 w-100"
                                style="margin-right: 0; margin-left: 0; max-width: 100%;">
                                <div class="card modern-card">
                                    <div class="card-header" style="background: #fff;">
                                        <div class="header-content">
                                            ...
                                            <div class="header-text">
                                                ...
                                                <p class="card-subtitle text-muted mb-0">Define cuántos días de gracia se
                                                    darán antes de considerar un pago como retrasado</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form id="tolerancia-form" action="{{ route('ajustes.toleranciaPagos') }}"
                                            method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" class="form-control modern-input"
                                                                id="tolerancia_dias" name="tolerancia_dias"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <button type="button" class="btn btn-outline-primary btn-sm"
                                                                onclick="setTolerancia(0)">
                                                                0 días (estricto)
                                                            </button>
                                                            <button type="button" class="btn btn-outline-primary btn-sm"
                                                                onclick="setTolerancia(3)">
                                                                3 días (moderado)
                                                            </button>
                                                            <button type="button" class="btn btn-outline-primary btn-sm"
                                                                onclick="setTolerancia(7)">
                                                                7 días (flexible)
                                                            </button>
                                                            <button type="button" class="btn btn-outline-primary btn-sm"
                                                                onclick="setTolerancia(15)">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="card bg-light h-100">
                                                        <div class="card-body">
                                                            <div class="tolerance-preview p-3 rounded w-100"
                                                                style="background: linear-gradient(135deg, #fff3cd 0%, #ffeeba 100%); border-left: 4px solid #ff6b35;">
                                                                <div class="d-flex align-items-start">
                                                                    <i
                                                                        class="bi bi-calendar-check text-warning me-2 mt-1"></i>
                                                                    <div>
                                                                        <small class="text-muted d-block mb-1">Con la
                                                                            configuración actual:</small>
                                                                        <p id="previewTolerancia" class="mb-2"
                                                                            style="font-size: 0.95rem; line-height: 1.4;">
                                                                            Los pagos se considerarán retrasados
                                                                            <strong><span
                                                                                    id="diasActuales">{{ $toleranciaPagos ?? 0 }}</span>
                                                                                día(s)</strong> después de su fecha de
                                                                            vencimiento.
                                                                        </p>
                                                                        <div class="small text-muted">
                                                                            <strong>Ejemplo:</strong> Un pago con
                                                                            vencimiento el 1 de septiembre se marcará como
                                                                            retrasado el <span
                                                                                id="fechaEjemplo">{{ now()->addDays($toleranciaPagos ?? 0)->format('d \d\e F') }}</span>.
                                                                        </div>
                                                                        @php
