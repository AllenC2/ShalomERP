                                    ...
                                    <div class="mb-2 mt-auto">
                                        <h2 class="fw-bold mb-0" style="font-size: 1.5rem; color: #2d3748;">
                                            @if($pago->tipo_pago === 'cuota' && $pago->numero_cuota)
                                                ...
                                                <small class="text-muted" style="font-size: 0.7em;">(Folio
                                                    #{{ str_pad($pago->id ?? 0, 6, '0', STR_PAD_LEFT) }})</small>
                                            @else
                                                Recibo de Pago
                                                #{{ str_pad($pago->numero_pago ?? $pago->id ?? 0, 6, '0', STR_PAD_LEFT) }}
                                            @endif
                                        </h2>
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    <div class="avatar-circle me-3 d-flex align-items-center justify-content-center"
                                                        style="min-width: 45px; min-height: 45px; width: 45px; height: 45px; background: linear-gradient(135deg, #E1B240 0%, #79481D 100%); border-radius: 50%; border: 2px solid #dee2e6;">
                                                        {{ strtoupper(substr($cliente->nombre, 0, 1) . substr($cliente->apellido, 0, 1)) }}
                                                    </div>
                                                    <div>
                                                        <div class="fw-semibold text-dark">{{ $cliente->nombre }}
                                                    ...
                                                    @if($pago->contrato->cliente->email)
                                                        <div class="col-md-12">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <span
                                                                    class="text-muted small">{{ $pago->contrato->cliente->email }}</span>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if($pago->contrato->cliente->telefono)
                                                        <div class="col-md-12">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <span
                                                                    class="text-muted small">{{ $pago->contrato->cliente->telefono }}</span>
                                                            </div>
                                                        </div>
                                                    @endif
                                        ...
                                        <div class="card border rounded" style="background: none; border-color: #e3e3e3;">
                                            <div class="card-body p-3 text-center">
                                                    ...
                                                    <div class="col-4 d-flex justify-content-center">
                                                        @if($isImage)
                                                            ...
                                                            <div class="document-thumbnail"
                                                                style="width: 80px; height: 80px; border-radius: 8px; overflow: hidden; border: 2px solid #dee2e6; cursor: pointer;"
                                                                onclick="openDocumentModal('{{ $documentoUrl }}', '{{ $fileName }}', 'image')">
                                                                <img src="{{ $documentoUrl }}" alt="Documento adjunto"
                                                                    style="width: 100%; height: 100%; object-fit: cover;">
                                                            </div>
                                                        @elseif($isPDF)
                                                            <!-- Icono de PDF -->
                                                            <div class="document-thumbnail d-flex align-items-center justify-content-center"
                                                                style="width: 80px; height: 80px; border-radius: 8px; background: linear-gradient(135deg, #dc3545 0%, #b02a37 100%); color: white; cursor: pointer; border: 2px solid #dee2e6;"
                                                                onclick="openDocumentModal('{{ $documentoUrl }}', '{{ $fileName }}', 'pdf')">
                                                                <i class="bi bi-file-earmark-pdf-fill" style="font-size: 32px;"></i>
                                                            </div>
                                                        @else
                                                            <!-- Icono genérico de archivo -->
                                                            <div class="document-thumbnail d-flex align-items-center justify-content-center"
                                                                style="width: 80px; height: 80px; border-radius: 8px; background: linear-gradient(135deg, #6c757d 0%, #495057 100%); color: white; cursor: pointer; border: 2px solid #dee2e6;"
                                                                onclick="openDocumentModal('{{ $documentoUrl }}', '{{ $fileName }}', 'file')">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <button class="btn btn-outline-primary btn-sm flex-grow-1 mx-1 d-print-none"
                                                        onclick="openDocumentModal('{{ $documentoUrl }}', '{{ $fileName }}', '{{ $isImage ? 'image' : ($isPDF ? 'pdf' : 'file') }}')"
                                                        title="Ver documento">
                                                        <i class="bi bi-eye me-1"></i> Ver
                                                    </button>
                                                    <a href="{{ $documentoUrl }}"
                                                        class="btn btn-outline-secondary btn-sm flex-grow-1 mx-1 d-print-none"
                                                        download="{{ $fileName }}" title="Descargar">
                                                        <i class="bi bi-download me-1"></i> Descargar
                                                    </a>
                                                    <button class="btn btn-outline-danger btn-sm flex-grow-1 mx-1 d-print-none"
                                                        onclick="eliminarDocumento({{ $pago->id }})" title="Eliminar documento">
                                        ...
                                        <div class="card border rounded" style="background: none; border-color: #e3e3e3;">
                                            <div class="card-body p-3">
                                                ...
                                                <div id="dropZone" class="border border-dashed rounded p-4 text-center"
                                                    style="border-color: #dee2e6; background: #f8f9fa; cursor: pointer; transition: all 0.3s ease;">
                                                    <input type="file" id="documentInput" class="d-none"
                                                        accept=".pdf,.jpg,.jpeg,.png,.gif,.bmp,.webp">
                                                    <div id="dropZoneContent">
                                                        <i class="bi bi-plus-circle text-primary mb-2" style="font-size: 2rem;"></i>
                                                        <p class="mb-1 fw-semibold">Arrastra un archivo aquí o haz clic para
                                                            seleccionar</p>
                                                ...
                                                <div>
                                                    <div class="mb-1">
                                                        <span class="fw-bold mb-0"
                                                            style="font-weight:900; font-size:2em;">${{ number_format($pago->monto, 2) }}
                                                            MXN</span>
                                                    </div>
                                                    <div class="mb-1">
                                                        <small class="d-block text-muted">
                                                            <i class="bi bi-tag me-1"></i>Tipo de pago: <span
                                                                class="fw-bold">{{ ucfirst($pago->tipo_pago ?? 'N/A') }}</span>
                                                        </small>
                                                    </div>
                                                    <div class="mb-1">
                                                        <small class="d-block text-muted">
                                                            ...
                                                            @if(strtolower($pago->estado) === 'hecho')
                                                                <div class="d-inline-block position-relative">
                                                                    <select id="metodo_pago_select"
                                                                        ...
                                                                        style="width: auto; font-size: 0.875rem; font-weight: bold; padding-right: 2rem;">
                                                                    ...
                                                                    <i class="bi bi-pencil-square position-absolute text-muted"
                                                                        style="right: 0.5rem; top: 50%; transform: translateY(-50%); font-size: 0.7rem; pointer-events: none;"></i>
                                                                    <span id="loading_metodo"
                                                                        class="spinner-border spinner-border-sm ms-2 d-none"
                                                                        role="status" aria-hidden="true"></span>
                                                                    <span
                                                                        class="d-none d-print-inline fw-bold">{{ \App\Models\Pago::METODOS_PAGO[$pago->metodo_pago] ?? $pago->metodo_pago }}</span>
                                                                </div>
                                                            @else
                                                                <span
                                                                    class="fw-bold text-muted">{{ \App\Models\Pago::METODOS_PAGO[$pago->metodo_pago] ?? $pago->metodo_pago }}</span>
                                                            @endif
                                                        </small>
                                                    </div>
                                                    <div>
                                                        <small class="d-block text-muted">
                                                            ...
                                                            <span
                                                                class="badge {{ $pago->estado == 'hecho' ? 'bg-success' : ($pago->estado == 'pendiente' ? 'bg-warning' : 'bg-danger') }}">
                                                                {{ ucfirst($pago->estado) }}
                                                            </span>
                                                        </small>
                                                    </div>
                                                        ...
                                                        <div class="text-center">
                                                            <div class="position-relative d-inline-block">
                                                                <svg width="80" height="80" class="progress-ring">
                                                                    <!-- Círculo de fondo -->
                                                                    <circle cx="40" cy="40" r="35" fill="none" stroke="#d1d5db"
                                                                        stroke-width="6" />
                                                                    <!-- Círculo de progreso -->
                                                                    <circle cx="40" cy="40" r="35" fill="none" stroke="#198754"
                                                    ...
                                                    <div class="row text-center">
                                                        ...
                                                        <div class="col-12 mb-2">
                                                            <div class="d-flex justify-content-between align-items-center text-sm">
                                                                ...
                                                                <small
                                                                    class="fw-bold">${{ number_format($pago->contrato->monto_total, 2) }}</small>
                                                            </div>
                                                            <div class="d-flex justify-content-between align-items-center text-sm">
                                                                ...
                                                                @endif
                                                                <small
                                                                    class="text-success fw-bold">${{ number_format($montoTotalPagado, 2) }}</small>
                                                            </div>
                                                            <hr class="my-1">
                                                            <div class="d-flex justify-content-between align-items-center text-sm">
                                                                <small class="text-muted fw-bold">Saldo Restante:</small>
                                                                <small
                                                                    class="fw-bold {{ $montoRestante <= 0 ? 'text-success' : 'text-danger' }}">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="border rounded p-3 bg-light">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-md-3">
                                                                        ...
                                                                        <div class="fw-bold text-info">
                                                                            ${{ number_format($montoOriginalCuota, 2) }}</div>
                                                                    </div>
                                                                    <div class="col-sm-12 col-md-3">
                                                                        <small class="text-muted">Total en parcialidades:</small>
                                                                        <div class="fw-bold text-success">
                                                                            ${{ number_format($totalParcialidades, 2) }}</div>
                                                                    </div>
                                                                    <div class="col-sm-12 col-md-3">
                                                                        <small class="text-muted">Monto actual de la cuota:</small>
                                                                        <div class="fw-bold text-primary">
                                                                            ${{ number_format($montoActualCuota, 2) }}</div>
                                                                    </div>
                                                                    <div class="col-sm-12 col-md-3">
                                                            ...
                                                            <div class="border-top pt-3">
                                                                <small class="text-muted fw-bold d-block mb-2">Detalle de
                                                                    parcialidades:</small>
                                                                @foreach($pago->parcialidades->sortBy('created_at') as $parcialidad)
                                                                    <div class="d-flex justify-content-between align-items-center py-1">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <span
                                                                                class="badge bg-success me-2">${{ number_format($parcialidad->monto, 2) }}</span>
                                                                            <span
                                                                                class="badge {{ $parcialidad->estado == 'hecho' ? 'bg-success' : 'bg-warning' }}">
                                                        ...
                                                        <div class="border rounded p-3 bg-info bg-opacity-10">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                                    ...
                                                                    <small
                                                                        class="text-muted">{{ $pago->pagoPadre->observaciones }}</small>
                                                                </div>
                                                                <div class="text-end">
                        ...
                        <div class="text-center mt-4 mb-3 d-print-none">
                            ...
                            @if(strtolower($pago->estado) === 'hecho')
                                <button class="btn btn-warning me-2 position-relative" id="btnDeshacerPago"
                                    ...
                                    data-monto="{{ $pago->monto }}" data-numero-cuota="{{ $pago->observaciones }}"
                                    title="Deshacer este pago">
                                    <i class="bi bi-arrow-counterclockwise me-1"></i> Deshacer Pago
                                    <span class="spinner-border spinner-border-sm ms-2 d-none" id="loadingDeshacerBtn" role="status"
