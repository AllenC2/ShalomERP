    ...
    <div class="page-wrapper">
        ...
        <div class="alert-warning-custom">
            ...
            <div class="alert-content">
                ...
                <p class="alert-text">La modificación de registros de pagos puede afectar la integridad financiera del sistema. Asegúrese de verificar toda la información antes de guardar los cambios. Esta acción quedará registrada en el historial del sistema.</p>
            </div>
        </div>

        <!-- Formulario -->
        <div class="">
            <form method="POST" action="{{ route('pagos.update', $pago->id) }}" enctype="multipart/form-data" autocomplete="off" class="">
                {{ method_field('PATCH') }}
                @csrf
                @include('pago.form')
            </form>
